...
class Generator {
    ...
    std::string getMesh(std::map<std::string, std::string> meshIdCache, const std::vector<ObjectPlacementPossibility>& placements, const std::string &objectPrefix, const std::string &cat);
